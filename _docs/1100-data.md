...
[How to disable OS battery optimization](../9999-faq/#how2-battery-optimization)
<br class="shot-end">
...
> [Garmins FIT format](https://developer.garmin.com/fit) or TCX (where the fields of the type _dateTime_ has also only
...
information can massively improve your logged elevation profile](../3250-elevation/#too).
